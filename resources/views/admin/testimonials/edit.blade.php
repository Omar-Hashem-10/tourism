...
@section('title', __('admin.edit') . ' ' . __('admin.testimonial_review_col'))
@section('page-title', __('admin.edit') . ' ' . __('admin.testimonial_review_col'))

@section('content')
<div class="admin-page-header">
    <div class="admin-page-title">{{ __('admin.edit') }}: {{ $testimonial->name }}</div>
            ...
            <div class="admin-card">
                ...
                <div style="padding:1.25rem;">
                    <div class="admin-form-group" style="margin:0;">
                        ...
                        <textarea name="review" class="admin-textarea" rows="5" required>{{ old('review', $testimonial->review) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="admin-card" style="margin-bottom:1.25rem;">
                ...
                <div style="padding:1.25rem;">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1rem;">
                        ...
                        <label class="toggle-switch"><input type="checkbox" name="is_active" value="1" {{ $testimonial->is_active?'checked':'' }}><span class="toggle-slider"></span></label>
                    </div>
                    <div class="admin-form-group" style="margin:0;">
                        <label class="admin-label">{{ __('admin.customer_image') }}</label>
                        @php $avatarMedia = $testimonial->getFirstMedia('avatar'); @endphp
                        @if($avatarMedia)
                            <div style="margin-bottom:0.5rem;">
                                <img src="{{ $avatarMedia->getUrl() }}" alt="{{ $testimonial->name }}" style="width:60px; height:60px; border-radius:50%; object-fit:cover; border:2px solid #E2E8F0;">
                            </div>
                        @endif
